structure(list(url = "https://api.open-meteo.com/v1/forecast?latitude=45.46427&longitude=9.18951&timezone=auto&hourly=lksdfj", 
    status_code = 400L, headers = structure(list(date = "Mon, 07 Aug 2023 13:18:07 GMT", 
    ...
    "list")), all_headers = list(list(status = 400L, version = "HTTP/2", 
        headers = structure(list(date = "Mon, 07 Aug 2023 13:18:07 GMT", 
    ...
    date = structure(1691414287, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.001383, 
    connect = 0.366638, pretransfer = 1.066002, starttransfer = 1.348552, 
    total = 1.348674)), class = "response")
